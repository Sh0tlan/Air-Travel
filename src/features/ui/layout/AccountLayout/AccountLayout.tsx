...
import ErrorBoundary from '@config/routes/components/ErroBoundary';
...
export default function AccountLayout() {
  ...
  // This call is needed to cause re-render then you change
  // the url, so boundary from another page also re-renders
